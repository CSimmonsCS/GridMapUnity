...
public class Grid<TGridObject>
{
    ...
    public void SetValue(Vector3 worldPosition, TGridObject value)//sets value based on location (mouseclick)
    {
        int x, y;
    ...
    public TGridObject GetValue(Vector3 worldPosition)//gets value based on location (mouseclick)
    {
        int x, y;
